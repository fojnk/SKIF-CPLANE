...
import { EntityType, UserRightsDC } from '@/modules/control-plane/shared/types';
import { VkUser } from '@/modules/control-plane/shared/ui';
import { getUserSimpleRight } from '@/modules/control-plane/shared/utils/aclHelpers';
import {
  loadTableSettings,
  saveTableSettings,
...
export const AclUsersTable = ({
  ...
  const settingsStorageKey = 'cp_users_table_settings_v1';
