...
import { DsUpdateModel } from '@/modules/control-plane/features/dataset/update';
import {
  EDIT_CONFIG_RIGHT,
  EDIT_SCHEMA_RIGHT,
} from '@/modules/control-plane/pages/editor/constants';
...
sample({
  ...
  fn: (entity, result) => {
    ...
    const canEdit =
      rights?.some((right: controlPlaneApi.dc.AclRightDC) => {
        if (entity === 'ds') {
