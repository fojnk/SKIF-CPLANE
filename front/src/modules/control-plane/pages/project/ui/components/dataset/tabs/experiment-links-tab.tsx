...
import { SFPagination } from '@/modules/control-plane/shared/components';
            ...
            template: (item: DsExperimentLinkDC) =>
              item.project_id && item.experiment_id ? (
                <Link
                  ...
                  to={`${ControlPlaneModule.routes.project.path}?id=${item.project_id}&selected=pipe-${item.experiment_id}`}
                  onClick={(e) => {
