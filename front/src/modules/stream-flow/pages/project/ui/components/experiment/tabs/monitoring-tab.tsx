...
import {
  MonitoringLogModel,
  ShowLogPayload,
} from '@/modules/stream-flow/features/logs/monitoring-log';
...
import { ButtonWithProgress, LogViewer } from '@/modules/stream-flow/shared/ui';
import { MonitoringSettingsButton } from '@/modules/stream-flow/shared/ui/buttons';
import { getPipeStatusColor } from '@/modules/stream-flow/shared/utils/getStatusColor';
...
interface MonitoringTabState {
  loading: boolean;
  failed: boolean;
  status: streamFlowApi.dc.ResponsesExperimentStatusResponseDC | null;
  hasStatus: boolean;
  hasMessage: boolean;
  hasDebug: boolean;
