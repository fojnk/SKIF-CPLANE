...
import { SetVersionCommentModel } from '@/modules/stream-flow/features/variable/version/comment/set-comment';
...
export const VariablesVersions = ({
  ...
  const settingsStorageKey = 'sf_variable_versions_table_settings_v2';
