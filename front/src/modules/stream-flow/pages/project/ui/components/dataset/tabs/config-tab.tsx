...
import { dsFormModel } from '@/modules/stream-flow/entities/forms/dataset';
...
import { DatasetType, ProjectInfoDC } from '@/modules/stream-flow/shared/types';
...
export const ConfigTab = ({ dataset_id, project }: Props) => {
  ...
  const canEdit = useMemo(
    () => (rights ?? []).includes(streamFlowApi.dc.AclRightDC.RightEditConfig),
    [rights],
  );
