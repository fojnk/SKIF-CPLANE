...
import { NO_SCROLL_TABS_PIPE } from '@/modules/stream-flow/pages/project/constants';
...
const renderTabContent = (
  ...
  project: ProjectInfoDC,
  rights: streamFlowApi.dc.AclRightDC[] | null,
) => {
  switch (activeTab) {
    case 'config':
    ...
    case 'alerts':
      return <AlertsTab experiment_id={experimentId} />;
    default:
      return null;
  }
};
