...
import { ShowDatasetLogModel } from '@/modules/stream-flow/features/logs/show-log/dataset';
import { ShowExperimentLogModel } from '@/modules/stream-flow/features/logs/show-log/experiment';
...
import { LogsTable } from '@/modules/stream-flow/shared/components/logs/logs-table';
import {
  PageDataDC,
  EntityType,
  LogDataDC,
