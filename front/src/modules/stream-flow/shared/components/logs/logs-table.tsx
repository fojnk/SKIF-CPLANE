...
import { SetLogCommentModel } from '@/modules/stream-flow/features/logs/set-comment';
...
import { getActionColor } from '@/modules/stream-flow/shared/utils/getActionColor';
import {
  loadTableSettings,
  saveTableSettings,
...
export const LogsTable = ({ data, onRowClick, user, type }: Props) => {
  ...
  const settingsStorageKey = 'sf_logs_table_settings_v1';
