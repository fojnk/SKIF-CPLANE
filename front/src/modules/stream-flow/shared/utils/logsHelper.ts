...
type DsDetails =
  | streamFlowApi.dc.UpdateLogDatasetUpdateLogDC
  | null
  | undefined;

type NsDetails =
  | streamFlowApi.dc.UpdateLogNamespaceUpdateLogDC
  | null
  | undefined;

type ProjectDetails =
  | streamFlowApi.dc.UpdateLogProjectUpdateLogDC
  | null
  | undefined;

type ExperimentDetails =
  | streamFlowApi.dc.UpdateLogExperimentUpdateLogDC
  | null
  | undefined;
