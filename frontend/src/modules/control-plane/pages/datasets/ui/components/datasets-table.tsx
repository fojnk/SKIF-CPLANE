...
import { DSCatalog, DsCatalogFilter } from '@/modules/control-plane/shared/types';
import { DatasetTypeLabel } from '@/modules/control-plane/shared/ui';
import { formatDate } from '@/modules/control-plane/shared/utils/formatVersionDate';
import { getAgoTime } from '@/modules/control-plane/shared/utils/getAgoTime';
import {
  loadTableSettings,
  saveTableSettings,
...
export const DatasetsTable = ({
  ...
  const settingsStorageKey = 'cp_catalog_ds_table_settings_v1';
