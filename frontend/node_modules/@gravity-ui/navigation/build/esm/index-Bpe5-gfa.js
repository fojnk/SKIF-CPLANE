...
const AllPagesListItem = (props) => {
    ...
    return (React__default.createElement(Tag, Object.assign({}, tagProps, { className: b$u(), onClick: onItemClick }),
        item.icon ? (React__default.createElement(Icon, { className: b$u('icon'), data: item.icon, size: item.iconSize })) : null,
        React__default.createElement("span", { className: b$u('text') }, item.title),
...
const Logo = ({ text, icon, iconSrc, iconClassName, iconPlaceClassName, iconSize = 24, textSize = 15, href, target = '_self', wrapper, onClick, compact, className, buttonClassName, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby, }) => {
    ...
    let buttonIcon;
    if (iconSrc) {
        buttonIcon = (React__default.createElement("span", { className: iconClassName },
...
var css_248z$i = ".gn-action-bar-item{list-style:none;margin:0;padding:0}.gn-action-bar-item_pull_left{justify-content:flex-start;margin-left:0;margin-right:auto}.gn-action-bar-item_pull_left-grow{flex-grow:1}.gn-action-bar-item_pull_right{justify-content:flex-end;margin-left:auto;margin-right:0}.gn-action-bar-item_pull_right-grow{flex-grow:1}.gn-action-bar-item_pull_center{justify-content:center;margin-left:auto;margin-right:auto}.gn-action-bar-item_pull_center-grow{flex-grow:1}.gn-action-bar-item+.gn-action-bar-item_spacing{margin-left:8px}";
...
var css_248z$h = ".gn-action-bar-section{align-items:stretch;display:flex;flex-flow:row nowrap;justify-content:flex-start}.gn-action-bar-section+.gn-action-bar-section{border-left:1px solid var(--g-color-line-generic)}.gn-action-bar-section_type_primary{flex:1 1 auto;padding-left:20px;padding-right:20px}.gn-action-bar-section_type_secondary{padding-left:6px;padding-right:6px}";
...
var css_248z$g = ".gn-action-bar-separator{border-right:1px solid var(--g-color-line-generic);height:40px;list-style:none;margin:0 6px;padding:0}";
styleInject(css_248z$g);

const b$h = block('action-bar-separator');
const ActionBarSeparator = () => {
    return React__default.createElement("li", { role: "separator", className: b$h(), "aria-hidden": true });
};
ActionBarSeparator.displayName = 'ActionBar.Separator';

var css_248z$f = ".gn-action-bar{align-items:stretch;border-bottom:1px solid var(--g-color-line-generic);box-sizing:border-box;display:flex;flex-flow:row nowrap;height:40px;justify-content:flex-start}";
...
var i18n$2 = addComponentKeysets({ en: en$2, ru: ru$2 }, `${NAMESPACE}${COMPONENT$2}`);

var css_248z$e = ".gn-title{align-items:center;box-sizing:border-box;display:flex;justify-content:space-between;min-height:64px;padding:14px 10px 14px 20px}.gn-title_separator{border-bottom:1px solid var(--g-color-line-generic)}.gn-title__text{margin:0 20px 0 0}";
styleInject(css_248z$e);

const b$f = block('title');
const Title = ({ children, closeIconSize = 23, hasSeparator, closeTitle = i18n$2('button_close'), onClose, }) => {
    return (React__default.createElement("div", { className: b$f({ separator: hasSeparator }) },
        React__default.createElement(Text, { className: b$f('text'), as: 'h3', variant: 'subheader-3' }, children),
...
function SettingsMenu({ items, onChange, activeItemId }, ref) {
    ...
    return (React__default.createElement("div", { ref: containerRef, className: b$d() }, items.map((firstLevelItem) => {
        if ('groupTitle' in firstLevelItem) {
            return (React__default.createElement("div", { key: firstLevelItem.groupTitle, className: b$d('group') },
                React__default.createElement("span", { className: b$d('group-heading') }, firstLevelItem.groupTitle),
...
function renderMenuItem(item, onChange, activeItemId, focusItemId) {
    return (React__default.createElement("span", { key: item.title, className: b$d('item', {
        ...
        item.icon ? React__default.createElement(Icon, Object.assign({ size: 16 }, item.icon, { className: b$d('item-icon') })) : undefined,
        React__default.createElement("span", null, item.title)));
}
function focusNext(container, focused, direction) {
    var _a;
    const elements = container.querySelectorAll(`.${b$d('item')}:not(.${b$d('item')}_disabled)`);
...
var css_248z$b = ".gn-settings-menu-mobile.g-tabs_direction_horizontal{-ms-overflow-style:none;flex-wrap:nowrap;overflow-x:auto;overscroll-behavior-x:none;scrollbar-width:none}.gn-settings-menu-mobile.g-tabs_direction_horizontal::-webkit-scrollbar{display:none}.gn-settings-menu-mobile__item_badge{position:relative}.gn-settings-menu-mobile__item_badge:after{background-color:var(--g-color-text-danger);border-radius:50%;content:\"\";display:block;height:6px;position:absolute;right:-8px;top:11px;width:6px}";
styleInject(css_248z$b);

const b$c = block('settings-menu-mobile');
        ...
        items.forEach((firstLevelItem) => {
            if ('groupTitle' in firstLevelItem) {
                tabItems.push(...firstLevelItem.items.map(({ id, title, disabled, withBadge }) => ({
                    ...
                    title,
                    disabled,
                    className: b$c('item', { badge: withBadge }),
                })));
            }
            else {
                const { id, title, disabled, withBadge } = firstLevelItem;
                tabItems.push({ id, title, disabled, className: b$c('item', { badge: withBadge }) });
            }
        });
        return tabItems;
    }, [items]);
...
var css_248z$9 = ".gn-mobile-logo{align-items:center;display:flex;gap:var(--g-spacing-2);overflow:hidden}.gn-mobile-logo:is(a),.gn-mobile-logo:is(a):active,.gn-mobile-logo:is(a):focus,.gn-mobile-logo:is(a):hover,.gn-mobile-logo:is(a):visited{color:var(--g-color-text-primary);outline:none;text-decoration:none}.gn-mobile-logo__icon{flex-shrink:0}.gn-mobile-logo__title{font-family:var(--g-text-header-font-family);font-size:var(--g-text-header-1-font-size);font-weight:var(--g-text-header-font-weight);line-height:var(--g-text-header-1-line-height);overflow:hidden;text-overflow:ellipsis;white-space:nowrap}";
styleInject(css_248z$9);

const b$9 = block('mobile-logo');
const MobileLogo = ({ text, compact, icon, iconSrc, iconClassName, iconSize = 32, textSize = 20, href = '/', target = '_self', wrapper, onClick, className, }) => {
    ...
    if (iconSrc) {
        ...
        logoIcon = React__default.createElement(Icon, { data: icon, size: iconSize, className: b$9('icon', iconClassName) });
    }
    let logoTitle;
    if (typeof text === 'function') {
        logoTitle = text();
...
const Item = ({ item, onItemClick }) => {
    ...
    const node = (React__default.createElement("div", { className: b$7('item', { type }), onClick: () => {
        ...
        React__default.createElement("div", { className: b$7('item-icon-place') }, icon && React__default.createElement(Icon, { data: icon, size: iconSize, className: b$7('item-icon') })),
        React__default.createElement("div", { className: b$7('item-title') }, item.title)));
    if (typeof item.itemWrapper === 'function') {
        return item.itemWrapper(node, item);
    }
    return item.link ? (React__default.createElement("a", { href: item.link, className: b$7('link') }, node)) : (node);
};
Item.displayName = 'Item';
const BurgerCompositeBar = React__default.memo(({ items, onItemClick }) => {
    return (React__default.createElement("nav", { className: b$7() },
        React__default.createElement(List, { items: items, selectedItemIndex: getSelectedItemIndex(items), itemHeight: getItemHeight, itemClassName: b$7('root-menu-item'), virtualized: false, filterable: false, sortable: false, renderItem: (item) => React__default.createElement(Item, { item: item, onItemClick: onItemClick }) })));
});
BurgerCompositeBar.displayName = 'BurgerCompositeBar';

var css_248z$6 = ".gn-mobile-header-burger-menu{display:flex;flex-direction:column;height:100%}.gn-mobile-header-burger-menu__footer{border-top:1px solid var(--g-color-base-generic);display:flex;margin-top:auto}";
styleInject(css_248z$6);

const b$6 = block('mobile-header-burger-menu');
const BurgerMenu = React__default.memo(({ items = [], renderFooter, modalItem, className, onItemClick }) => {
    var _a;
    return (React__default.createElement("div", { className: b$6(null, className) },
        modalItem && (React__default.createElement(Sheet, { visible: modalItem.visible, id: modalItem.id, title: modalItem.title, onClose: modalItem.onClose, contentClassName: modalItem.contentClassName, className: modalItem.className }, (_a = modalItem.renderContent) === null || _a === undefined ? undefined : _a.call(modalItem))),
        React__default.createElement(BurgerCompositeBar, { items: items, onItemClick: onItemClick }),
        renderFooter && React__default.createElement("div", { className: b$6('footer') }, renderFooter === null || renderFooter === undefined ? undefined : renderFooter())));
});
    ...
    return (React__default.createElement(Drawer, { className: b$5('', { action: Boolean(action) }, className), onVeilClick: onClose, onEscape: onClose, style: drawerStyle },
        React__default.createElement(DrawerItem, { id: "overlap", ref: itemRef, visible: visible, className: b$5('drawer-item'), style: drawerItemStyle },
            React__default.createElement("div", { className: b$5('header') },
                ...
                React__default.createElement(Text, { whiteSpace: "nowrap", ellipsis: true, variant: 'subheader-2', className: b$5('title'), as: title ? 'h2' : undefined }, title),
                action && (React__default.createElement(Button, { size: "l", type: "button", view: "flat", onClick: action.onClick, className: b$5('action'), "aria-label": action.title },
...
const MobileHeader = React__default.forwardRef(({ logo, burgerMenu, burgerCloseTitle = i18n('burger_button_close'), burgerOpenTitle = i18n('burger_button_open'), panelItems = [], renderContent, sideItemRenderContent, onClosePanel, onEvent, className, contentClassName, overlapPanel, topAlert, }, ref) => {
    ...
    const onMobilePanelOpen = useCallback(({ detail }) => {
        if (typeof (detail === null || detail === undefined ? undefined : detail.panelName) === 'string') {
            ...
            setVisiblePanel(detail === null || detail === undefined ? undefined : detail.panelName);
            setOverlapPanelVisible(false);
        }
    }, [onEvent]);
    ...
    const onCloseDrawer = useCallback(() => {
        if (visiblePanel) {
            onEvent === null || onEvent === undefined ? undefined : onEvent(visiblePanel, MOBILE_HEADER_EVENT_NAMES.closeEvent);
        }
        setVisiblePanel(null);
    ...
    return (React__default.createElement("div", { className: b$4({ compact }, className), ref: targetRef },
        React__default.createElement("div", { className: b$4('header-container') },
            ...
            React__default.createElement("header", { className: b$4('header'), style: { height: size } },
                React__default.createElement(Burger, { opened: visiblePanel === burgerPanelItem.id, onClick: () => onPanelToggle(BURGER_PANEL_ITEM_ID), className: b$4('burger'), closeTitle: burgerCloseTitle, openTitle: burgerOpenTitle }),
                React__default.createElement(MobileLogo, Object.assign({}, logo, { compact: compact, onClick: onLogoClick })),
                React__default.createElement("div", { className: b$4('side-item') }, sideItemRenderContent === null || sideItemRenderContent === undefined ? undefined : sideItemRenderContent({ size })))),
        React__default.createElement(Drawer, { className: b$4('panels'), onVeilClick: onCloseDrawer, onEscape: onCloseDrawer, style: { top: `calc(${size}px + var(--gn-top-alert-height, 0px))` } }, [burgerPanelItem, ...panelItems].map((item) => (React__default.createElement(DrawerItem, Object.assign({}, item, { key: item.id, visible: visiblePanel === item.id, className: b$4('panel-item', item.className) }))))),
        overlapPanel && (React__default.createElement(OverlapPanel, { topOffset: size, className: b$4('overlap-panel'), title: overlapPanel.title, onClose: onOverlapClose, action: overlapPanel.action, visible: overlapPanelVisible, renderContent: overlapPanel.renderContent })),
        React__default.createElement(Content, { size: size, renderContent: renderContent, className: b$4('content', contentClassName), cssSizeVariableName: "--mobile-header-size" })));
});
MobileHeader.displayName = 'MobileHeader';

var css_248z$3 = ".gn-mobile-header-footer-item{flex-grow:1;position:relative}.gn-mobile-header-footer-item__button{align-items:center;background:none;border:none;box-sizing:border-box;color:inherit;cursor:pointer;display:flex;font-family:var(--g-text-body-font-family);font-size:inherit;font-weight:var(--g-text-body-font-weight);justify-content:center;outline:none;padding:13px 10px;width:100%}.gn-mobile-header-footer-item .gn-mobile-header-footer-item__icon{color:var(--g-color-text-misc)}.gn-mobile-header-footer-item+.gn-mobile-header-footer-item:before{border-left:1px solid var(--g-color-base-generic);bottom:8px;content:\"\";left:0;position:absolute;top:8px}.gn-mobile-header-footer-item:empty{display:none}";
styleInject(css_248z$3);

const b$3 = block('mobile-header-footer-item');
const FooterItem = ({ icon, iconSize = MOBILE_HEADER_ICON_SIZE, className, modalItem = { visible: false }, onClick, eventBrokerMeta, }) => {
    ...
    return (React__default.createElement("div", { className: b$3() },
        React__default.createElement("button", { className: b$3('button', className), onClick: handleClick }, icon ? React__default.createElement(Icon, { data: icon, size: iconSize, className: b$3('icon') }) : null),
        React__default.createElement(Sheet, { id: modalItem.id, title: modalItem.title, visible: modalItem.visible, className: b$3('modal', modalItem.className), contentClassName: b$3('modal-content', modalItem.contentClassName), allowHideOnContentScroll: modalItem.modalAllowHideOnContentScroll, onClose: modalItem.onClose }, (_a = modalItem.renderContent) === null || _a === undefined ? undefined : _a.call(modalItem))));
};
