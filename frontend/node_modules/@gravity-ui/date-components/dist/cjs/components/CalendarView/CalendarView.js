...
const useCalendarCellProps_1 = require("./hooks/useCalendarCellProps.js");
const useCalendarGridProps_1 = require("./hooks/useCalendarGridProps.js");
const useCalendarProps_1 = require("./hooks/useCalendarProps.js");
...
exports.CalendarView = react_1.default.forwardRef(function Calendar(props, ref) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", Object.assign({}, calendarProps, { className: b({ size: props.size }, props.className), style: props.style, children: [(0, jsx_runtime_1.jsxs)("div", { className: b('header'), children: [(0, jsx_runtime_1.jsx)(uikit_1.Button, Object.assign({}, modeButtonProps, { view: buttonView, size: props.size, children: state.availableModes.indexOf(state.mode) + 1 ===
                        ...
                        ]) })), (0, jsx_runtime_1.jsxs)("div", { className: b('controls'), children: [(0, jsx_runtime_1.jsx)(uikit_1.Button, Object.assign({}, previousButtonProps, { view: buttonView, size: props.size, children: (0, jsx_runtime_1.jsx)(uikit_1.Button.Icon, { children: (0, jsx_runtime_1.jsx)(icons_1.ChevronLeft, { className: b('control-icon') }) }) })), (0, jsx_runtime_1.jsx)(uikit_1.Button, Object.assign({}, nextButtonProps, { view: buttonView, size: props.size, children: (0, jsx_runtime_1.jsx)(uikit_1.Button.Icon, { children: (0, jsx_runtime_1.jsx)(icons_1.ChevronRight, { className: b('control-icon') }) }) }))] })] }), (0, jsx_runtime_1.jsx)(CalendarGrid, { state: state })] })));
});
