...
export function getFormatInfo(sections) {
    var _a, _b;
...
export function adjustDateToFormat(date, formatInfo, method = 'startOf') {
    let newDate = date;
...
export function markValidSection(allSections, editableSections, unit) {
