...
import { getCalendarModes } from "../../DatePicker/utils/index.js";
import { useRelativeDateFieldProps } from "../../RelativeDateField/index.js";
...
export function useRelativeDatePickerProps(state, _a) {
    ...
    delete DOMProps.id;
    return {
        groupProps: Object.assign(Object.assign(Object.assign(Object.assign({}, DOMProps), { ref: groupRef, tabIndex: -1, role: 'group' }), focusWithinProps), { onKeyDown: (e) => {
...
//# sourceMappingURL=useRelativeDatePickerProps.js.map
