...
import type { SortableListProps } from "../SortableList/index.js";
import type { SortableListDndContextProps } from "../SortableListDndContext/index.js";
import "./ReorderingProvider.css";
...
export declare const ReorderingProvider: <TData>({ table, children, dndModifiers, enableNesting, onReorder, }: ReorderingProviderProps<TData>) => import("react/jsx-runtime").JSX.Element;
