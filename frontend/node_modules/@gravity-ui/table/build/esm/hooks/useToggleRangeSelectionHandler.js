...
import { LastSelectedRowContext } from "../components/LastSelectedRowContext/index.js";
export const useToggleRangeSelectionHandler = (cellContext) => {
    ...
    return (event) => {
        ...
        const hasNestedRows = rows.some((rootLevelRow) => Array.isArray(rootLevelRow.subRows) && rootLevelRow.subRows.length > 0);
        if (hasNestedRows ||
...
//# sourceMappingURL=useToggleRangeSelectionHandler.js.map
