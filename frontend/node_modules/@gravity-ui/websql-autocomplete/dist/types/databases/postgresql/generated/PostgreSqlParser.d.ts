...
export declare class PostgreSqlParser extends PostgreSqlParserBase {
    ...
    static readonly RULE_tableName = 613;
    static readonly RULE_tableIdentifier = 614;
    static readonly RULE_tableIdentifierList = 615;
    static readonly RULE_sequenceName = 616;
    static readonly RULE_sequenceNameList = 617;
    static readonly RULE_qualifiedName = 618;
    static readonly RULE_nameList = 619;
    static readonly RULE_name = 620;
    static readonly RULE_attributeName = 621;
    static readonly RULE_fileName = 622;
    static readonly RULE_functionName = 623;
    static readonly RULE_aExpressionConst = 624;
    static readonly RULE_xconst = 625;
    static readonly RULE_bconst = 626;
    static readonly RULE_fconst = 627;
    static readonly RULE_iconst = 628;
    static readonly RULE_sconst = 629;
    static readonly RULE_anySconst = 630;
    static readonly RULE_optionalUescape = 631;
    static readonly RULE_signedIconst = 632;
    static readonly RULE_roleName = 633;
    static readonly RULE_roleNameList = 634;
    static readonly RULE_columnId = 635;
    static readonly RULE_tableAlias = 636;
    static readonly RULE_typeFunctionName = 637;
    static readonly RULE_nonReservedWord = 638;
    static readonly RULE_columnLabel = 639;
    static readonly RULE_identifier = 640;
    static readonly RULE_plsqlIdentifier = 641;
    static readonly RULE_unreservedKeyword = 642;
    static readonly RULE_columnNameKeyword = 643;
    static readonly RULE_typeFunctionNameKeyword = 644;
    static readonly RULE_reservedKeyword = 645;
    static readonly RULE_builtinFunctionName = 646;
    static readonly RULE_plsqlFunction = 647;
    static readonly RULE_computeOptions = 648;
    static readonly RULE_computeOption = 649;
    static readonly RULE_sharp = 650;
    static readonly RULE_optionValue = 651;
    static readonly RULE_optionalSemi = 652;
    static readonly RULE_plsqlBlock = 653;
    static readonly RULE_declareSection = 654;
    static readonly RULE_declareStart = 655;
    static readonly RULE_declareStatements = 656;
    static readonly RULE_labelDeclaration = 657;
    static readonly RULE_declareStatement = 658;
    static readonly RULE_declareStatement2 = 659;
    static readonly RULE_optionalScrollable = 660;
    static readonly RULE_declareCursorQuery = 661;
    static readonly RULE_declareCursorArgs = 662;
    static readonly RULE_declareCursorArglist = 663;
    static readonly RULE_declareCursorArg = 664;
    static readonly RULE_declareIsOrFor = 665;
    static readonly RULE_declareAliasItem = 666;
    static readonly RULE_declareVarname = 667;
    static readonly RULE_declareConst = 668;
    static readonly RULE_declareDatatype = 669;
    static readonly RULE_declareCollate = 670;
    static readonly RULE_declareNotNull = 671;
    static readonly RULE_declareDefaultValue = 672;
    static readonly RULE_declareDefaultKey = 673;
    static readonly RULE_assignOperator = 674;
    static readonly RULE_procedureSection = 675;
    static readonly RULE_proceduralStatement = 676;
    static readonly RULE_statementPerform = 677;
    static readonly RULE_statementCall = 678;
    static readonly RULE_optionalExpressionList = 679;
    static readonly RULE_statementAssign = 680;
    static readonly RULE_statementGetDiagram = 681;
    static readonly RULE_optionalGetDiagramArea = 682;
    static readonly RULE_getDiagramList = 683;
    static readonly RULE_getDiagramListItem = 684;
    static readonly RULE_getDiagramItem = 685;
    static readonly RULE_getDiagramTarget = 686;
    static readonly RULE_assignVariable = 687;
    static readonly RULE_statementIf = 688;
    static readonly RULE_statementElsifs = 689;
    static readonly RULE_statementElse = 690;
    static readonly RULE_statementCase = 691;
    static readonly RULE_optionalExpressionUntilWhen = 692;
    static readonly RULE_caseWhenList = 693;
    static readonly RULE_caseWhen = 694;
    static readonly RULE_optionalCaseElse = 695;
    static readonly RULE_statementLoop = 696;
    static readonly RULE_statementWhile = 697;
    static readonly RULE_statementFor = 698;
    static readonly RULE_forControl = 699;
    static readonly RULE_optionalForUsingExpression = 700;
    static readonly RULE_optionalCursorParameters = 701;
    static readonly RULE_optionalReverse = 702;
    static readonly RULE_optionalByExpression = 703;
    static readonly RULE_forVariable = 704;
    static readonly RULE_statementForeachA = 705;
    static readonly RULE_foreachSlice = 706;
    static readonly RULE_statementExit = 707;
    static readonly RULE_exitType = 708;
    static readonly RULE_statementReturn = 709;
    static readonly RULE_optionalReturnResult = 710;
    static readonly RULE_statementRaise = 711;
    static readonly RULE_optionalStatementRaiseLevel = 712;
    static readonly RULE_optionalRaiseList = 713;
    static readonly RULE_optionalRaiseUsing = 714;
    static readonly RULE_optionalRaiseUsingElement = 715;
    static readonly RULE_statementAssert = 716;
    static readonly RULE_optionalStatementAssertMessage = 717;
    static readonly RULE_loopBody = 718;
    static readonly RULE_statementExecSql = 719;
    static readonly RULE_statementDynExecute = 720;
    static readonly RULE_optionalExecuteUsing = 721;
    static readonly RULE_optionalExecuteUsingList = 722;
    static readonly RULE_optionalExecuteInto = 723;
    static readonly RULE_statementOpen = 724;
    static readonly RULE_optionalOpenBoundListItem = 725;
    static readonly RULE_statementFetch = 726;
    static readonly RULE_intoTarget = 727;
    static readonly RULE_optionalCursorFrom = 728;
    static readonly RULE_optionalFetchDirection = 729;
    static readonly RULE_statementMove = 730;
    static readonly RULE_statementClose = 731;
    static readonly RULE_statementNull = 732;
    static readonly RULE_statementCommit = 733;
    static readonly RULE_statementRollback = 734;
    static readonly RULE_plsqlOptionalTransactionChain = 735;
    static readonly RULE_statementSet = 736;
    static readonly RULE_cursorVariable = 737;
    static readonly RULE_exceptionSection = 738;
    static readonly RULE_procedureExceptions = 739;
    static readonly RULE_procedureException = 740;
    static readonly RULE_procedureConditions = 741;
    static readonly RULE_procedureCondition = 742;
    static readonly RULE_optionalBlockLabel = 743;
    static readonly RULE_optionalLoopLabel = 744;
    static readonly RULE_optionalLabel = 745;
    static readonly RULE_optionalExitCondition = 746;
    static readonly RULE_anyIdentifier = 747;
    static readonly RULE_plsqlUnreservedKeyword = 748;
    static readonly RULE_sqlExpression = 749;
    static readonly RULE_expressionUntilThen = 750;
    static readonly RULE_expressionUntilSemi = 751;
    static readonly RULE_expressionUntilRightbracket = 752;
    static readonly RULE_expressionUntilLoop = 753;
    static readonly RULE_makeExecuteSqlStatement = 754;
    static readonly RULE_optionalReturningClauseInto = 755;
    static readonly RULE_roleOrAliases = 756;
    ...
    tableIdentifierList(): TableIdentifierListContext;
...
export declare class DropStatementContext extends antlr.ParserRuleContext {
    ...
    EXISTS(): antlr.TerminalNode | null;
    TABLE(): antlr.TerminalNode | null;
    tableIdentifierList(): TableIdentifierListContext | null;
    SEQUENCE(): antlr.TerminalNode | null;
...
export declare class TableIdentifierListContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    tableIdentifier(): TableIdentifierContext[];
