...
export declare class MySqlParser extends antlr.Parser {
    ...
    static readonly RULE_tableNameWithDotPrefix = 278;
    static readonly RULE_tableIdentifier = 279;
    static readonly RULE_tableIdentifiers = 280;
    static readonly RULE_userOrRoleName = 281;
    static readonly RULE_userOrRoleNameList = 282;
    static readonly RULE_newRoleNameList = 283;
    static readonly RULE_newRoleName = 284;
    static readonly RULE_roleNameList = 285;
    static readonly RULE_roleName = 286;
    static readonly RULE_fullColumnName = 287;
    static readonly RULE_databaseName = 288;
    static readonly RULE_indexName = 289;
    static readonly RULE_constraintName = 290;
    static readonly RULE_triggerName = 291;
    static readonly RULE_indexNameList = 292;
    static readonly RULE_indexColumnName = 293;
    static readonly RULE_simpleUserName = 294;
    static readonly RULE_hostName = 295;
    static readonly RULE_userNameList = 296;
    static readonly RULE_newUserName = 297;
    static readonly RULE_userName = 298;
    static readonly RULE_mysqlVariable = 299;
    static readonly RULE_charsetName = 300;
    static readonly RULE_collationName = 301;
    static readonly RULE_engineName = 302;
    static readonly RULE_engineNameBase = 303;
    static readonly RULE_uuidSet = 304;
    static readonly RULE_xid = 305;
    static readonly RULE_xuidStringId = 306;
    static readonly RULE_authPlugin = 307;
    static readonly RULE_uid = 308;
    static readonly RULE_simpleId = 309;
    static readonly RULE_dottedId = 310;
    static readonly RULE_decimalLiteral = 311;
    static readonly RULE_fileSizeLiteral = 312;
    static readonly RULE_stringLiteral = 313;
    static readonly RULE_booleanLiteral = 314;
    static readonly RULE_hexadecimalLiteral = 315;
    static readonly RULE_nullNotnull = 316;
    static readonly RULE_constant = 317;
    static readonly RULE_dataType = 318;
    static readonly RULE_collectionOptions = 319;
    static readonly RULE_convertedDataType = 320;
    static readonly RULE_lengthOneDimension = 321;
    static readonly RULE_lengthTwoDimension = 322;
    static readonly RULE_lengthTwoOptionalDimension = 323;
    static readonly RULE_uidList = 324;
    static readonly RULE_fullColumnNameList = 325;
    static readonly RULE_tables = 326;
    static readonly RULE_indexColumnNames = 327;
    static readonly RULE_expressions = 328;
    static readonly RULE_expressionsWithDefaults = 329;
    static readonly RULE_constants = 330;
    static readonly RULE_simpleStrings = 331;
    static readonly RULE_userVariables = 332;
    static readonly RULE_defaultValue = 333;
    static readonly RULE_currentTimestamp = 334;
    static readonly RULE_expressionOrDefault = 335;
    static readonly RULE_ifExists = 336;
    static readonly RULE_ifNotExists = 337;
    static readonly RULE_orReplace = 338;
    static readonly RULE_waitNowaitClause = 339;
    static readonly RULE_functionCall = 340;
    static readonly RULE_specificFunction = 341;
    static readonly RULE_caseFuncAlternative = 342;
    static readonly RULE_levelsInWeightString = 343;
    static readonly RULE_levelInWeightListElement = 344;
    static readonly RULE_aggregateWindowedFunction = 345;
    static readonly RULE_nonAggregateWindowedFunction = 346;
    static readonly RULE_overClause = 347;
    static readonly RULE_windowSpec = 348;
    static readonly RULE_windowName = 349;
    static readonly RULE_frameClause = 350;
    static readonly RULE_frameUnits = 351;
    static readonly RULE_frameExtent = 352;
    static readonly RULE_frameBetween = 353;
    static readonly RULE_frameRange = 354;
    static readonly RULE_partitionClause = 355;
    static readonly RULE_scalarFunctionName = 356;
    static readonly RULE_passwordFunctionClause = 357;
    static readonly RULE_functionArgs = 358;
    static readonly RULE_functionArg = 359;
    static readonly RULE_expression = 360;
    static readonly RULE_predicate = 361;
    static readonly RULE_expressionAtom = 362;
    static readonly RULE_unaryOperator = 363;
    static readonly RULE_comparisonOperator = 364;
    static readonly RULE_logicalOperator = 365;
    static readonly RULE_bitOperator = 366;
    static readonly RULE_multOperator = 367;
    static readonly RULE_addOperator = 368;
    static readonly RULE_jsonOperator = 369;
    static readonly RULE_charsetNameBase = 370;
    static readonly RULE_transactionLevelBase = 371;
    static readonly RULE_privilegesBase = 372;
    static readonly RULE_intervalTypeBase = 373;
    static readonly RULE_dataTypeBase = 374;
    static readonly RULE_keywordsCanBeId = 375;
    static readonly RULE_functionNameBase = 376;
    ...
    tableNameWithDotPrefix(): TableNameWithDotPrefixContext;
    tableIdentifier(): TableIdentifierContext;
    tableIdentifiers(): TableIdentifiersContext;
...
export declare class CopyCreateTableContext extends CreateTableContext {
    _parenthesisTable?: TableIdentifierContext;
...
export declare class TablePairContext extends antlr.ParserRuleContext {
    _firstTable?: TableIdentifierContext;
    _secondTable?: TableIdentifierContext;
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    LR_BRACKET(): antlr.TerminalNode;
    COMMA(): antlr.TerminalNode;
    RR_BRACKET(): antlr.TerminalNode;
...
export declare class TableNameWithDotPrefixContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
...
export declare class TableIdentifierContext extends antlr.ParserRuleContext {
    ...
    tableNameWithDotPrefix(): TableNameWithDotPrefixContext | null;
    tableName(): TableNameContext | null;
    DOT(): antlr.TerminalNode | null;
    get ruleIndex(): number;
    accept<Result>(visitor: MySqlParserVisitor<Result>): Result | null;
}
export declare class TableIdentifiersContext extends antlr.ParserRuleContext {
    constructor(parent: antlr.ParserRuleContext | null, invokingState: number);
    tableIdentifier(): TableIdentifierContext[];
    tableIdentifier(i: number): TableIdentifierContext | null;
    COMMA(): antlr.TerminalNode[];
