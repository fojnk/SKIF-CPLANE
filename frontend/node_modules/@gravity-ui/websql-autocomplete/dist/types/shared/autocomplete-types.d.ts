import { AbstractParseTreeVisitor, CharStream, CommonTokenStream, Lexer as LexerType, ParseTree, ParserRuleContext, Parser as ParserType, TokenStream } from 'antlr4ng';
import * as c3 from 'antlr4-c3';
import { TokenPosition } from './cursor';
import { TableQueryPosition, TokenDictionary } from './tables';
export { ExtractStatementPositionsResult, StatementExtractionStrategy, } from './extract-statement-positions-from-query';
...
export declare enum TableOrViewSuggestion {
    ALL = "ALL",
    TABLES = "TABLES",
    VIEWS = "VIEWS"
}
...
export type GetParseTree<P> = (parser: P, type?: TableQueryPosition['type'] | 'select') => ParseTree;
...
export type ProcessVisitedRules<A extends AutocompleteResultBase> = (rules: c3.CandidatesCollection['rules'], cursorTokenIndex: number, tokenStream: TokenStream) => ProcessVisitedRulesResult<A>;
export type EnrichAutocompleteResult<A extends AutocompleteResultBase> = (result: AutocompleteResultBase, rules: c3.CandidatesCollection['rules'], tokenStream: TokenStream, cursorTokenIndex: number, cursor: CursorPosition, query: string) => A;
export interface AutocompleteData<A extends AutocompleteResultBase, L extends LexerType, P extends ParserType> {
