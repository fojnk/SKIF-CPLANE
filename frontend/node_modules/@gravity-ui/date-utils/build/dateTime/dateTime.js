...
var regexParse_1 = require("./regexParse");
...
var DateTimeImpl = /** @class */ (function () {
    ...
    DateTimeImpl.prototype.isSame = function (input, granularity) {
        var ts = getTimestamp(input, 'system', this._locale)[0];
    ...
    DateTimeImpl.prototype.from = function (fromInput, withoutSuffix) {
        if (!this.isValid()) {
            return this._localeData.invalidDate || constants_1.INVALID_DATE_STRING;
        }
        var value = DateTimeImpl.isDateTime(fromInput)
        ...
        var months = b.month() - a.month() + (b.year() - a.year()) * 12;
        if (a.add(months, 'months').isAfter(b)) {
            months--;
        }
        var milliseconds = b.valueOf() - a.add(months, 'months').valueOf();
        if (switched) {
            months = -months;
            milliseconds = -milliseconds;
        }
        return (0, relative_1.fromTo)((0, duration_1.duration)({ months: months, milliseconds: milliseconds }), this._localeData.relativeTime, withoutSuffix);
    };
    ...
    DateTimeImpl.prototype.set = function (unit, amount) {
        ...
        if (settingWeekStuff) {
            ...
            if (hasLocalWeekData) {
                var _d = (0, locale_1.getLocaleWeekValues)(this._localeData), minDaysInFirstWeek = _d.minDaysInFirstWeek, startOfWeek = _d.startOfWeek;
                var weekData = {
    ...
    DateTimeImpl.prototype.weeksInYear = function () {
        var _a = (0, locale_1.getLocaleWeekValues)(this._localeData), minDaysInFirstWeek = _a.minDaysInFirstWeek, startOfWeek = _a.startOfWeek;
    ...
    DateTimeImpl.prototype.weekInfo = function () {
        if (!this._weekInfo) {
            var _a = (0, locale_1.getLocaleWeekValues)(this._localeData), startOfWeek = _a.startOfWeek, minDaysInFirstWeek = _a.minDaysInFirstWeek;
...
function createDateTime(_a) {
    ...
    var loc = locale || 'en';
    var localeData = (0, locale_1.getLocaleData)(loc);
...
function getTimestamp(input, timezone, locale, format, fixedOffset) {
    ...
    if (isDateTime(input) ||
        ...
        _a = (0, parse_1.getTimestampFromArray)(input, timezone, fixedOffset), ts = _a[0], offset = _a[1];
    }
    else if (typeof input === 'object') {
        _b = (0, parse_1.getTimestampFromObject)(input, timezone, fixedOffset), ts = _b[0], offset = _b[1];
    }
    else if (format === undefined) {
        var _d = (0, regexParse_1.parseDateString)(input), dateObject = _d[0], timezoneOrOffset = _d[1];
        if (Object.keys(dateObject).length === 0) {
            return [NaN, NaN];
        }
        ts = (0, parse_1.getTimestampFromObject)(dateObject, typeof timezoneOrOffset === 'string' ? timezoneOrOffset : 'system', typeof timezoneOrOffset === 'number' ? timezoneOrOffset : fixedOffset)[0];
...
function dateTime(opt) {
    ...
    var _b = getTimestamp(input, timeZoneOrDefault, locale, format), ts = _b[0], offset = _b[1];
...
function dateTimeUtc(opt) {
    var _a = opt || {}, input = _a.input, format = _a.format, lang = _a.lang, _b = _a.offset, offset = _b === void 0 ? 0 : _b;
    var locale = dayjs_1.default.locale(lang || settings_1.settings.getLocale(), undefined, true);
    var ts = getTimestamp(input, constants_1.UtcTimeZone, locale, format, offset)[0];
    var date = createDateTime({
        ts: ts,
        timeZone: constants_1.UtcTimeZone,
        offset: offset,
