...
export declare function getListFormat(locale: string, options?: Intl.ListFormatOptions): any;
export declare function getNumberFormat(locale: string, options?: Intl.NumberFormatOptions): Intl.NumberFormat;
export declare function getLocaleData(locale: string): Locale;
export declare function getLocaleWeekValues(localeData: {
    yearStart?: number;
    weekStart?: number;
}): {
    startOfWeek: number;
