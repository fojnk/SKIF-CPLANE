...
// New creates a new idm API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

// New creates a new idm API client with basic auth credentials.
...
// New creates a new idm API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
/*
PostAPIV2IdmNamespaceRoles creates and push namespace roles to idm
*/
func (a *Client) PostAPIV2IdmNamespaceRoles(params *PostAPIV2IdmNamespaceRolesParams, opts ...ClientOption) (*PostAPIV2IdmNamespaceRolesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewPostAPIV2IdmNamespaceRolesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PostAPIV2IdmNamespaceRoles",
		Method:             "POST",
		PathPattern:        "/api/v2/idm/namespace/roles",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PostAPIV2IdmNamespaceRolesReader{formats: a.formats},
	...
	success, ok := result.(*PostAPIV2IdmNamespaceRolesOK)
	if ok {
		return success, nil
	}
	...
	msg := fmt.Sprintf("unexpected success response for PostAPIV2IdmNamespaceRoles: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PostAPIV2IdmProjectRoles(params *PostAPIV2IdmProjectRolesParams, opts ...ClientOption) (*PostAPIV2IdmProjectRolesOK, error) {
	// NOTE: parameters are not validated before sending
	if params == nil {
		params = NewPostAPIV2IdmProjectRolesParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "PostAPIV2IdmProjectRoles",
		Method:             "POST",
		PathPattern:        "/api/v2/idm/project/roles",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http"},
		Params:             params,
		Reader:             &PostAPIV2IdmProjectRolesReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	for _, opt := range opts {
	...
	// only one success response has to be checked
	success, ok := result.(*PostAPIV2IdmProjectRolesOK)
	if ok {
		return success, nil
	}
